...
export const es: Content = {
  ...
  f3_desc:   'Añade campos, ordénalos a tu gusto y documenta cada pieza en profundidad, con ayuda de las bases de datos de Numista y OCRE y de la inteligencia artificial. Visualiza tus monedas y billetes, juntos o por separado.',
