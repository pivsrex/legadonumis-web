...
export const en: Content = {
  ...
  f3_desc:   'Add fields, arrange them as you like, and document each piece in depth, with help from the Numista and OCRE databases and AI. View your coins and banknotes together or separately.',
  ...
  faq3_a: 'The app works offline for managing and browsing your data. Some features — the map, live bullion prices, currency conversion, Numista and OCRE integration, and AI content generation — require an internet connection.',
