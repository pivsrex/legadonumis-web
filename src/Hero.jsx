...
const MAC_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.6/Legado-1.2.6-arm64.dmg';
const WIN_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.6/Legado-Setup-1.2.6.exe';
