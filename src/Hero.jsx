...
const MAC_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.7/Legado-1.2.7-arm64.dmg';
const WIN_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.7/Legado-Setup-1.2.7.exe';
