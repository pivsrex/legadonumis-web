...
const MAC_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.0/Legado-1.2.0-arm64.dmg';
const WIN_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.0/Legado-Setup-1.2.0.exe';
