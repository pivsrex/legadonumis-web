...
const MAC_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.2/Legado-1.2.2-arm64.dmg';
const WIN_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.2.2/Legado-Setup-1.2.2.exe';
