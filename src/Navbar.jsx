...
const MAC_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.0.6/Legado-1.0.6-arm64.dmg';
const WIN_URL = 'https://github.com/pivsrex/Legado-releases/releases/download/v1.0.6/Legado-Setup-1.0.6.exe';
